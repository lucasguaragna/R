...
```{r}
hist(dados$`NS atendimento`, main = "Análise de Densidade", xlab = "NS Atendimento (%)", ylab = "Densidade", prob = T, las = 1)
...
```{r}
hist(dados$`NS atendimento`, main = "Histograma do NS Atendimento", xlab = "NS Atendimento (%)", ylab = "Frequência", prob = F, las = 1)
